...
//        public AddressRepo(project0Context dbcontext)
//        {
//            Context = dbcontext;
//        }
...
//        public void AddAddress(Models.Address obj)
//        {
//            if (obj is null)
//            {
//                //log it!
...
//            else
//            {
//                Address adrs = Mapper.Map(obj);

//                if (GetTById(adrs.Id) != null) //if given address is already in db
//                {
//                    throw new ArgumentOutOfRangeException("Address with given id already exists.");
//                }
//                else
...
//                    try
//                    {
//                        Context.Address.Add(adrs); //add to local context
//                        Context.SaveChanges();  //run context.SaveChanges() to run the appropriate insert, adding it to db
//                    }
//                    catch (DbUpdateException)
//                    {
...
//        public void UpdateAddress(Models.Address obj)
//        {
//            if (obj is null)
//            {
//                //log it!
...
//                var existingAdd = GetTById(adrs.Id);
//                if (existingAdd != null) //if given address is actually in db
//                {
//                    //Context.Entry(existingAdd).CurrentValues.SetValues(obj); 
//                    //would update values for any type of obj in context, allowing generics
...
//                    //update local values
//                    Context.Entry(existingAdd).CurrentValues.SetValues(adrs);
...
//        public void DeleteAddress(Models.Address obj)
//        {
//            if (obj is null)
//            {
//                throw new ArgumentNullException("Cannot delete null address");
...
//                    try
//                    {
//                        Context.Address.Remove(adrs); //remove from local context
//                        Context.SaveChanges();  //run context.SaveChanges() to run the appropriate delete, removing it from db
//                    }
//                    catch (DbUpdateException)
//                    {
...
//        public IEnumerable<Models.Address> GetAllAddress()
//        {
//            // disable pointless tracking for performance
//            return Mapper.Map(Context.Address.AsNoTracking());
//        }
...
//        {
//            return Mapper.Map(Context.Address.Find(id)); //may return null, if it doesn't exist in db
//        }
